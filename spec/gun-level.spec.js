...
describe("gun-level", function () {
  ...
  describe('put method', function () {
    ...
    it('should not overwrite old data', function (done) {
      setup('').get('overwritten').put({
        property: 'value'
      }, function () {
        setup('').get('overwritten').put({
          otherProperty: 'value'
          ...
          expect(val.otherProperty).toBe('value');
          done();
        });
      });
    });
  ...
  describe('get method', function () {
    ...
    it('should not error out for existing keys', function (done) {
    ...
    it('should be able to find data by soul', function (done) {
      ...
      gun.get('get-test-key').path('object.prop').val(function (val) {
